...
import os
def analyze_text_length(csv_path, model_name="pretrained_models/sup-simcse-roberta-base"):
    ...
    for i in range(0, len(df), batch_size):
        batch_texts = df['text1'].iloc[i:i+batch_size].tolist()
...
def main():
    ...
    print(current_dir)
    # 构建CSV文件的完整路径
    csv_path = os.path.join(current_dir, 'hotel_samples.csv')
    model_name = os.path.join(
        '/home/maxon/disk2/roomMatch/room_match/chinese_match/checkpoints_mdeberta_result/best_model')
