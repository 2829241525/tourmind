...
# 配置信息
CONFIG = {
    'input_file': '/home/maxon/disk2/roomMatch/room_match/deberta/data/processed_merged_clean.csv',  # 输入CSV文件路径
    'output_file': '/home/maxon/disk2/roomMatch/room_match/deberta/data/processed_merged_cleaned.csv',  # 输出CSV文件路径
...
def main():
    try:
        ...
        # 检查目标列是否存在
        missing_columns = [col for col in CONFIG['target_columns'] if col not in df.columns]
        if missing_columns:
