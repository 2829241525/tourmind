...
def process_text_with_prefix(prefix: Optional[str], room_name: str, bed_name: str, is_supplier: bool = False) -> str:
    """处理文本，添加前缀并提取英文"""
...
async def match_rooms(request: MatchRequest):
    ...
    try:
        ...
        # 处理文本
        source_texts = [
            process_text_with_prefix(supplier, spl_room, spl_bed, True)
            for supplier, spl_room, spl_bed in zip(
                request.supplier_names,
