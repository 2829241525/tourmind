...
RESULT_FILE = os.path.join(DATA_DIR, 'all_country_data.csv')
SOURCE_FILE = os.path.join(DATA_DIR, 'positive_country.csv')
...
API_HEADERS = {
    ...
    'Cookie': 'admintools_user_session=MTc0MDExNjMzOXw4blJCNUlxbDFTcDJZSElUaDAxcmxjV3hOcmZuTlp2RjJ4OXdQOHBuVUhMRVp6V294Y2J3ZUJnY1F3Z2d6Zm1lUXdvRjVvQS03MGs9fHXO2ugutkbG2P7dM0oFPKeYN_1Ql0D7-7wHs0tG4pYc',
    ...
    try:
        ...
        for item in sorted_data:
            ...
            result.update({
                ...
                'similar': float(item.get('points', 0)),
